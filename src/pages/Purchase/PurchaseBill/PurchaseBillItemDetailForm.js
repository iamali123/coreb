...
import {
  PurchaseBillItemDetailValidationSchema,
  purchaseBillItemDetailsInitialValues,
...
import PurchaseBillItemDetailList from "./PurchaseBillItemDetailList";
function PurchaseInquiryItemDetailsForm(props) {
  ...
  const itemDetailFormik = useFormik({
    ...
    validationSchema: PurchaseBillItemDetailValidationSchema,
    enableReinitialize: true,
    onSubmit: (values, { resetForm }) => {
      let isDuplicateEntry = props.PurchaseBillMaterials.filter(
        (material) => material.itemDetailId === values.itemDetailId
      ).length;
      if (isDuplicateEntry > 0) {
        props.setPurchaseBillMaterials(
          props.PurchaseBillMaterials.map((material) => {
  ...
  return (
    <>
      ...
      <PurchaseBillItemDetailList
        SelectedData={props.SelectedData}
        setSelectedData={props.setSelectedData}
        PurchaseBillMaterials={props.PurchaseBillMaterials}
        setPurchaseBillMaterials={props.setPurchaseBillMaterials}
