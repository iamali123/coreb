...
const PurchaseInquiryItemDetailList = (props) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        props.setPurchaseInquiryMaterials(
          props.PurchaseInquiryMaterials.filter(
  ...
  return (
    <>
      <DataGrid
        columns={columns}
        data={props.PurchaseInquiryMaterials.reverse()}
        setSelectedData={props.setSelectedData}
        showTitle={false}
        showExportButton={false}
        EditHandler={props.EditPurchaseInquiryItemDetail}
...
export default PurchaseInquiryItemDetailList;
